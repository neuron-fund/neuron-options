...
contract MockONtoken is ERC20PermitUpgradeable {
    using SafeMath for uint256;

    /// @notice total amount of minted onTokens, does not decrease on burn when onToken is redeemed, but decreases when burnONToken is called by vault owner
    ...
    /// @notice amounts of collateralAssets used for collaterization of total supply of this onToken
    /// updated upon every mint
    uint256[] public collateralsAmounts;

    /// @notice value of collateral assets denominated in strike asset used for mint total supply of this onToken
    /// updated upon every mint
